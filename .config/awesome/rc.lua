...
-- Widgets from https://github.com/streetturtle/widgets/
...
local github_prs_widget = require("widgets.github-prs-widget")
...
globalkeys = gears.table.join(
    ...
    -- Volume
    awful.key({ }, "XF86AudioRaiseVolume", function() os.execute("pamixer -ui 5") end,
      {description = "Volume +10", group = "hotkeys"}),
    awful.key({ }, "XF86AudioLowerVolume", function() os.execute("pamixer -ud 5") end,
      {description = "Volume -10", group = "hotkeys"}),
